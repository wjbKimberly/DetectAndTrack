...
# the iou threshold when do nms operation to combine the bbox generated by optical and detector 
__C.TEST.NMS_OPTICAL=__C.TEST.NMS
# drop some keypoints generated by optical, it will effect the bbox generated by the keypoints
